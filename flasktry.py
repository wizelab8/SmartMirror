...
SHIRTS_DIR="clothing_accessories/shirts/";
PANTS_DIR="clothing_accessories/pants/";
i=str(input("Enter the shirt number you want to try"))
imgshirt = cv2.imread(SHIRTS_DIR+i+".png") #original img in bgr
i=str(input("Enter the pant number you want to try"))
imgpant = cv2.imread(PANTS_DIR+i+".png")
...
while True:
        ...
        img = cv2.resize(img[:,:,0:3],(400,400), interpolation = cv2.INTER_AREA)
